...
const SpaceWeather = () => {
  ...
  return (
    <div
      className="min-h-screen flex flex-col justify-between px-4 md:px-8 relative overflow-hidden"
      style={{
    ...
    >
      ...
      <div className="container mx-auto py-8 relative z-10">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-sm text-gray-600 mt-2 font-light">Last updated: {currentTime}</p>
        </div>

        {/* Grid Cards */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 max-w-6xl mx-auto mb-6">
          {/* Solar Flare Card */}
          <Card className="bg-gray-900/90 border-orange-500/30 backdrop-blur-xl md:scale-90 w-full">
            ...
            <CardContent className="space-y-3">
              <div className="flex justify-between items-center">
                ...
                <span
                  className={`px-2 py-1 rounded-full text-xs font-light ${
                    getRiskLevel('flares', solarFlares) === 'LOW'
                      ? 'bg-green-500 text-white'
                      : getRiskLevel('flares', solarFlares) === 'MODERATE'
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-white text-lg font-light">
                  {getActivityLevel(solarFlares)}/10
                </span>
              </div>
          ...
          {/* Geomagnetic Card */}
          <Card className="bg-gray-900/90 border-blue-500/30 backdrop-blur-xl md:scale-90 w-full">
            <CardHeader className="pb-3">
              <div className="flex items-center gap-2">
            ...
            <CardContent className="space-y-3">
              <div className="flex justify-between items-center">
                ...
                <span
                  className={`px-2 py-1 rounded-full text-xs font-light ${
                    getRiskLevel('geo', geoStorms) === 'LOW'
                      ? 'bg-green-500 text-white'
                      : getRiskLevel('geo', geoStorms) === 'MODERATE'
                      ? 'bg-orange-500 text-white'
                      : 'bg-red-500 text-white'
                  }`}
                >
          ...
          <Card className="bg-gray-900/90 border-green-500/30 backdrop-blur-xl md:scale-90 w-full">
            <CardHeader className="pb-3">
              <div className="flex items-center gap-2">
                <span className="text-xl">🌌</span>
        ...
        {/* Solar Wind Panel */}
        <Card className="bg-gray-900/90 border-purple-500/30 backdrop-blur-xl max-w-6xl mx-auto md:scale-90 w-full">
          <CardHeader>
            <div className="flex items-center gap-2">
              <span className="text-xl">💨</span>
